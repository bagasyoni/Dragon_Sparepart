...
class Transaksi_Pemesanan_Logistik extends CI_Controller
{
        ...
        foreach ($list as $pp) {
            ...
            $row[] = '<div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_PemesananLogistik/update/' . $pp->NO_ID) . '"> <i class="fa fa-edit"></i> Edit</a>
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_PemesananLogistik/delete/' . $pp->NO_ID) . '" onclick="return confirm(&quot; Apakah Anda Yakin Ingin Menghapus? &quot;)"><i class="fa fa-trash"></i> Delete</a>
    ...
    public function index_Transaksi_PemesananLogistik()
    {
        $dr = $this->session->userdata['dr'];
        $per = $this->session->userdata['periode'];
        $sub = $this->session->userdata['sub'];
        $this->session->set_userdata('judul', 'Transaksi Pemesanan Logistik');
        $where = array(
            'DR' => $dr,
            'PER' => $per,
            'SUB' => $sub,
        ...
        $this->load->view('admin/Transaksi_PemesananLogistik/Transaksi_PemesananLogistik', $data);
    ...
    public function input()
    {
        ...
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_PemesananLogistik/Transaksi_PemesananLogistik_form');
        $this->load->view('templates_admin/footer');
    }
    ...
    public function input_aksi()
    {
        ...
        redirect('admin/Transaksi_PemesananLogistik/index_Transaksi_PemesananLogistik');
    }
    ...
    public function update($id)
    {
        $q1 = "SELECT pp.NO_ID as ID,
            ...
            AND pp.NO_ID=ppd.ID 
            ORDER BY ppd.REC";
        $data['pemesananlogistik'] = $this->transaksi_model->edit_data($q1)->result();
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_PemesananLogistik/Transaksi_PemesananLogistik_update', $data);
        $this->load->view('templates_admin/footer');
    }
    ...
    function JASPER($id)
    {
        ...
        $PHPJasperXML->load_xml_file("phpjasperxml/Transaksi_PemesananLogistik.jrxml");
        $no_id = $id;
