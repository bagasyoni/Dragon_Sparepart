...
class Transaksi_PesananLasting extends CI_Controller
{
    ...
    var $column_order = array(null, null, null, 'NO_BUKTI', 'TGL', 'KD_BRG', 'PESAN');
    var $column_search = array('NO_BUKTI', 'TGL', 'KD_BRG', 'PESAN');
        ...
        foreach ($list as $pp) {
            ...
            $row[] = '<div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_PesananLasting/update/' . $pp->NO_ID) . '"> <i class="fa fa-edit"></i> Edit</a>
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_PesananLasting/delete/' . $pp->NO_ID) . '" onclick="return confirm(&quot; Apakah Anda Yakin Ingin Menghapus? &quot;)"><i class="fa fa-trash"></i> Delete</a>
    ...
    public function index_Transaksi_PesananLasting()
    {
        $per = $this->session->userdata['periode'];
        $dr= $this->session->userdata['dr'];
        ...
        $this->load->view('admin/Transaksi_PesananLasting/Transaksi_PesananLasting', $data);
    ...
    public function input()
    {
        ...
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_PesananLasting/Transaksi_PesananLasting_form');
        $this->load->view('templates_admin/footer');
    }
    ...
    public function input_aksi()
    {
        ...
        redirect('admin/Transaksi_PesananLasting/index_Transaksi_PesananLasting');
    }
    ...
    public function update($id)
    {
        ...
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_PesananLasting/Transaksi_PesananLasting_update', $data);
        $this->load->view('templates_admin/footer');
    }
