...
class Transaksi_PPStok extends CI_Controller
{
        ...
        foreach ($list as $pp) {
            ...
            $row[] = '<div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_PPStok/update/' . $pp->NO_ID) . '"> <i class="fa fa-edit"></i> Edit</a>
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_PPStok/delete/' . $pp->NO_ID) . '" onclick="return confirm(&quot; Apakah Anda Yakin Ingin Menghapus? &quot;)"><i class="fa fa-trash"></i> Delete</a>
    ...
    public function index_Transaksi_PPStok()
    {
        $dr = $this->session->userdata['dr'];
        $per = $this->session->userdata['periode'];
        $sub = $this->session->userdata['sub'];
        $this->session->set_userdata('judul', 'Transaksi Pemesanan PP Stok');
        $where = array(
            'DR' => $dr,
            'PER' => $per,
            'SUB' => $sub,
        ...
        $this->load->view('admin/Transaksi_PPStok/Transaksi_PPStok', $data);
    ...
    public function input()
    {
        ...
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_PPStok/Transaksi_PPStok_form');
        $this->load->view('templates_admin/footer');
    }
    ...
    public function update($id)
    {
        ...
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_PPStok/Transaksi_PPStok_update', $data);
        $this->load->view('templates_admin/footer');
    }
    ...
    public function getDataAjax_bhn()
    {
        ...
        $perPage = 10;
        $results = $this->db->query("SELECT bhn.NO_ID, bhn.KD_BHN, bhn.NA_BHN, bhn.SATUAN, bhnd.AW$per AS QTY, bhnd.RAK, bhnd.AK$per AS SISA 
            FROM bhn, bhnd
    ...
    function JASPER($id)
    {
        ...
        $PHPJasperXML->load_xml_file("phpjasperxml/Transaksi_PP_Stok.jrxml");
        $no_id = $id;
