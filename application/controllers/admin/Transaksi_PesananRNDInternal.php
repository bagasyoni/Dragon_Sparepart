...
class Transaksi_PesananRNDInternal extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        if ($this->session->userdata['menu_sparepart'] != 'pp') {
            ...
            $this->session->set_userdata('kode_menu', 'T0022');
    ...
    public function index_Transaksi_PesananRNDInternal()
    {
        $dr = $this->session->userdata['dr'];
        $per = $this->session->userdata['periode'];
        $sub = $this->session->userdata['sub'];
        ...
        $this->load->view('admin/Transaksi_PesananRNDInternal/Transaksi_PesananRNDInternal', $data);
    ...
    public function input()
    {
        ...
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_PesananRNDInternal/Transaksi_PesananRNDInternal_form');
        $this->load->view('templates_admin/footer');
    }
    ...
    public function update($id)
    {
        ...
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_PesananRNDInternal/Transaksi_PesananRNDInternal_update', $data);
        $this->load->view('templates_admin/footer');
    }
    ...
    function JASPER($id)
    {
        ...
        $PHPJasperXML->load_xml_file("phpjasperxml/Transaksi_Pesanan_RND_Internal.jrxml");
