...
class Transaksi_PesananRNDPembelian extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        if ($this->session->userdata['menu_sparepart'] != 'pp') {
            ...
            $this->session->set_userdata('kode_menu', 'T0023');
        ...
        foreach ($list as $pp) {
            ...
            $row[] = '<div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_PesananRNDPembelian/update/' . $pp->NO_ID) . '"> <i class="fa fa-edit"></i> Edit</a>
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_PesananRNDPembelian/delete/' . $pp->NO_ID) . '" onclick="return confirm(&quot; Apakah Anda Yakin Ingin Menghapus? &quot;)"><i class="fa fa-trash"></i> Delete</a>
    ...
    public function index_Transaksi_PesananRNDPembelian()
    {
        $dr = $this->session->userdata['dr'];
        $per = $this->session->userdata['periode'];
        $sub = $this->session->userdata['sub'];
        ...
        $this->load->view('admin/Transaksi_PesananRNDPembelian/Transaksi_PesananRNDPembelian', $data);
    ...
    public function input()
    {
        ...
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_PesananRNDPembelian/Transaksi_PesananRNDPembelian_form');
        $this->load->view('templates_admin/footer');
    }
    ...
    public function input_aksi()
    {
        ...
        $datah = array(
            ...
            'TGL_MARKETING' => date("Y-m-d", strtotime($this->input->post('TGL_MARKETING', TRUE))),
        ...
        redirect('admin/Transaksi_PesananRNDPembelian/index_Transaksi_PesananRNDPembelian');
    }
    ...
    public function update($id)
    {
        $q1 = "SELECT pp.NO_ID as ID,
                ...
                pp.NO_PO AS NO_PO,
                pp.TGL_MARKETING AS TGL_MARKETING,
        ...
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_PesananRNDPembelian/Transaksi_PesananRNDPembelian_update', $data);
        $this->load->view('templates_admin/footer');
    }
    ...
    function JASPER($id)
    {
        ...
        $PHPJasperXML->load_xml_file("phpjasperxml/Transaksi_Pemesanan_CNC.jrxml");
        $no_id = $id;
