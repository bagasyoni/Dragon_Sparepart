...
class Transaksi_PPLama extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        if ($this->session->userdata['menu_sparepart'] != 'pp') {
            ...
            $this->session->set_userdata('kode_menu', 'T0013');
        ...
        foreach ($list as $pp) {
            ...
            $row[] = '<div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_PPLama/update/' . $pp->NO_ID) . '"> <i class="fa fa-edit"></i> Val</a>
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_PPLama/delete/' . $pp->NO_ID) . '" onclick="return confirm(&quot; Apakah Anda Yakin Ingin Menghapus? &quot;)"><i class="fa fa-trash"></i> Delete</a>
    ...
    public function index_Transaksi_PPLama()
    {
        $dr = $this->session->userdata['dr'];
        $per = $this->session->userdata['periode'];
        $sub = $this->session->userdata['sub'];
        $this->session->set_userdata('judul', 'Transaksi Pemesanan PP Lama');
        $where = array(
            'DR' => $dr,
            'PER' => $per,
            'SUB' => $sub,
        ...
        $this->load->view('admin/Transaksi_PPLama/Transaksi_PPLama', $data);
    ...
    public function input()
    {
        ...
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_PPLama/Transaksi_PPLama_form');
        $this->load->view('templates_admin/footer');
    }
    ...
    public function input_aksi()
    {
        ...
        redirect('admin/Transaksi_PPLama/index_Transaksi_PPLama');
    }
    ...
    public function update($id)
    {
        ...
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_PPLama/Transaksi_PPLama_update', $data);
        $this->load->view('templates_admin/footer');
    }
    ...
    function JASPER($id)
    {
        ...
        $PHPJasperXML->load_xml_file("phpjasperxml/Transaksi_PP_Lama.jrxml");
        $no_id = $id;
