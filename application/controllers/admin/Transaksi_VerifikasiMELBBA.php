...
class Transaksi_VerifikasiMELBBA extends CI_Controller
{
    ...
    public function index_Transaksi_VerifikasiMELBBA()
    {
        ...
        $this->load->view('admin/Transaksi_VerifikasiMELBBA/Transaksi_VerifikasiMELBBA', $data);
    ...
    function delete_multiple()
    {
        ...
        redirect('admin/Transaksi_PesananPisau/index_Transaksi_VerifikasiMELBBA');
    }
