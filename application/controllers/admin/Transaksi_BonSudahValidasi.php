...
class Transaksi_BonSudahValidasi extends CI_Controller
{
        ...
        foreach ($list as $pp) {
            ...
            $row[] = '<div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a '.$hidden.' class="dropdown-item" href="' . site_url('admin/Transaksi_BonSudahValidasi/update/' . $pp->NO_ID) . '"> <i class="fa fa-edit"></i> Edit</a>
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_BonSudahValidasi/validasi/' . $pp->NO_ID) . '"> <i class="fa fa-check"></i> Validasi</a>
                            <a class="dropdown-item" href="' . site_url('admin/Transaksi_BonSudahValidasi/delete/' . $pp->NO_ID) . '" onclick="return confirm(&quot; Apakah Anda Yakin Ingin Menghapus? &quot;)"><i class="fa fa-trash"></i> Delete</a>
    ...
    public function index_Transaksi_BonSudahValidasi()
    {
        ...
        $this->load->view('admin/Transaksi_BonSudahValidasi/Transaksi_BonSudahValidasi', $data);
    ...
    public function input()
    {
        ...
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_BonSudahValidasi/Transaksi_BonSudahValidasi_form');
        $this->load->view('templates_admin/footer');
    }
    ...
    public function input_aksi()
    {
        ...
        if ( ! $this->upload->do_upload('GAMBAR1')){
			...
			$this->load->view('admin/Transaksi_BonSudahValidasi/Transaksi_BonSudahValidasi_form', $error);
		}else{
...
// die;
        ...
        redirect('admin/Transaksi_BonSudahValidasi/index_Transaksi_BonSudahValidasi');
    }
    ...
    public function update($NO_ID)
    {
        ...
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_BonSudahValidasi/Transaksi_BonSudahValidasi_update', $data);
        $this->load->view('templates_admin/footer');
    }
...
##############UPDATE
    ...
    public function validasi($NO_ID)
    {
        ...
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_BonSudahValidasi/Transaksi_BonSudahValidasi_validasi', $data);
        $this->load->view('templates_admin/footer');
    }
