...
class Transaksi_Verifikasi_PO extends CI_Controller {
    ...
    function JASPER($id) {
        ...
        $no_id = $id;
        $query = "SELECT bl_bon.no_id as ID,
                bl_bon.no_sp AS MODEL,
                bl_bon.perke AS PERKE,
                bl_bon.tgl_sp AS TGL_SP,
                bl_bon.nodo AS NODO,
                bl_bon.tgldo AS TGLDO,
                bl_bon.tlusin AS TLUSIN,
                bl_bon.tpair AS TPAIR,

                bl_bond.no_id AS NO_ID,
                bl_bond.rec AS REC,
                CONCAT(bl_bond.article,' - ',bl_bond.warna) AS ARTICLE,
                bl_bond.size AS SIZE,
                bl_bond.golong AS GOLONG,
                bl_bond.sisa AS SISA,
                bl_bond.lusin AS LUSIN,
                bl_bond.pair AS PAIR,
                CONCAT(bl_bond.kodecus,' - ',bl_bond.nama) AS KODECUS,
                bl_bond.kota AS KOTA
            FROM bl_bon,bl_bond 
            WHERE bl_bon.no_id=$id 
            AND bl_bon.no_id=bl_bond.id 
            ORDER BY bl_bond.rec";
