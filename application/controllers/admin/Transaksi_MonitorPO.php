...
class Transaksi_MonitorPO extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        if ($this->session->userdata['menu_sparepart'] != 'po') {
            ...
            $this->session->set_userdata('kode_menu', 'T0015');
    ...
    public function index_Transaksi_MonitorPO()
    {
        ...
        $this->load->view('admin/Transaksi_MonitorPO/Transaksi_MonitorPO', $data);
    ...
    public function input()
    {
        ...
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_MonitorPO/Transaksi_MonitorPO_form');
        $this->load->view('templates_admin/footer');
    }
    ...
    public function update($id)
    {
        $q1 = "SELECT po.NO_ID as ID,
            ...
            AND po.NO_ID = pod.ID 
            ORDER BY pod.REC";
        $data['monitor_po'] = $this->transaksi_model->edit_data($q1)->result();
        $this->load->view('templates_admin/header');
        $this->load->view('templates_admin/navbar');
        $this->load->view('admin/Transaksi_MonitorPO/Transaksi_MonitorPO_update', $data);
        $this->load->view('templates_admin/footer');
    }
