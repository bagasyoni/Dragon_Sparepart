			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2">
							<input class="form-control text_input JENIS" id="JENIS" name="JENIS" type="text" value="<?php echo $rowh->JENIS ?>">
						</div>
					</div>
				</div>
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2">
							<input class="form-control text_input M_LASTING" id="M_LASTING" name="M_LASTING" type="text" value="<?php echo $rowh->M_LASTING ?>">
						</div>
						<div class="col-md-1">
