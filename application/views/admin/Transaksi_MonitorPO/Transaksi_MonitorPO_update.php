...
<div class="container-fluid">
	...
	<form id="monitor_po" name="monitor_po" action="<?php echo base_url('admin/Transaksi_MonitorPO/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
				...
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2">
							<input class="form-control text_input NAMAS text_input" id="NAMAS" name="NAMAS" type="text" value="<?php echo $rowh->NAMAS ?>" required readonly>
						</div>
					</div>
				</div>
				<div class="col-md-12">
