...
<div class="container-fluid">
	...
	<form id="monitorpo" name="monitorpo" action="<?php echo base_url('admin/Transaksi_MonitorPO/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
				...
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2 input-group">
							<input name="KODES" id="KODES" maxlength="50" type="text" class="form-control KODES text_input" onkeypress="return tabE(this,event)" readonly>
...
<script>
	...
	function select_kd_bhn() {
		$('.js-example-responsive-kd_bhn').select2({
			ajax: {
				url: "<?= base_url('admin/Transaksi_MonitorPO/getDataAjax_bhn') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
