...
<div class="container-fluid">
	...
	<form id="lpbbengkel" name="lpbbengkel" action="<?php echo base_url('admin/Transaksi_LPBBengkel/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2">
							<input class="form-control text_input NO_BUKTI" id="NO_BUKTI" name="NO_BUKTI" type="text" value='' required>
						</div>
					</div>
				</div>
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2">
							<input 
								...
								value="<?php if (isset($_POST["tampilkan"])) { 
									echo $_POST["TGL"]; 
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody id="show-data">
							<tr>
								...
								<td>
									<div class='input-group'><select class='js-example-responsive-kd_bhn form-control KD_BHN0' name='KD_BHN[]' id="KD_BHN0" onchange="kd_bhn(this.id)" onfocusout="hitung()" required></select></div>
								</td>
...
<script>
				...
				// alert(response);
                    ...
                    for(i=0; i<response.length; i++){
                        html += '<tr>'+
									...
									'<td><input name="RAK[]" id=RAK'+i+' type="text" class="form-control RAK text_input" readonly></td>'+
									'<td><input name="QTY_BL[]" onclick="select()" value="'+numberWithCommas(response[i].QTY_BL)+'" onkeyup="hitung()" id=QTY_BL'+i+' type="text" class="form-control QTY_BL rightJustified text-primary"></td>'+
	...
	function tambah() {
		...
		var kd_bhn0 = "<div class='input-group'><select class='js-example-responsive-kd_bhn form-control KD_BHN0' name='KD_BHN[]' id=KD_BHN" + idrow + " onchange='kd_bhn(this.id)' onfocusout='hitung()' required></select></div>";
		...
		td7.innerHTML = "<input type='hidden' name='NO_ID[]' id=NO_ID" + idrow + " class='form-control'>" +
