...
<div class="container-fluid">
	...
	<form id="transaksiinventaris" name="transaksiinventaris" action="<?php echo base_url('admin/Transaksi_Inventaris/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody>
							<tr>
								...
								<td><input name="SISA[]" onkeyup="hitung()" value="0" id="SISA0" type="text" class="form-control SISA rightJustified text-primary" readonly></td>
								<td>
									<input name="URGENT[]" id="URGENT0" type="checkbox" value="1" class="checkbox_container" checked>
								</td>
								<td>
