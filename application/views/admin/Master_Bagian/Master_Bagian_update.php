...
<div class="container-fluid">
	...
	<form id="masterbagian" name="masterbagian" action="<?php echo base_url('admin/Master_Bagian/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<br><br>
		<div class="form-body">
			<div class="col-md-12">
				<div class="form-group row">
					...
					<div class="col-md-4">
						...
						<input type="text" id="NA_BAGIAN" name="NA_BAGIAN" class="form-control text_input NA_BAGIAN" value="<?= $NA_BAGIAN ?>">
					</div>
				</div>
			</div>
			<div class="col-md-12">
