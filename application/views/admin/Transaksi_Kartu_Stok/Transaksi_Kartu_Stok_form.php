...
<div class="container-fluid">
	...
	<form id="kartustok" name="kartustok" action="<?php echo base_url('admin/Transaksi_Kartu_Stok/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody>
							<tr>
								...
								<td><input name="KET2[]" id="KET20" type="text" class="form-control KET2"></td>
								<td>
...
<script>
	...
	function tambah() {
		...
		td8.innerHTML = "<input type='hidden' name='NO_ID[]' id=NO_ID" + idrow + "  class='form-control'>" +
