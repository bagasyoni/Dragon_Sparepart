...
<div class="container-fluid">
	...
	<form id="ppstok" name="ppstok" action="<?php echo base_url('admin/Transaksi_PesananOnline/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
