<?php
	foreach ($transaksi_koreksi_stok as $rowh) {};
?>
...
<div class="container-fluid">
	...
	<form id="koreksistok" name="koreksistok" action="<?php echo base_url('admin/Transaksi_Koreksi_Stok/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
			...
			<div class="col-md-12">
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<?php
							$no = 0;
							foreach ($transaksi_koreksi_stok as $row) : 
						?>
							<tr>
								...
								<td><input name="QTY_AK[]" onkeyup="hitung()" id="QTY_AK<?php echo $no; ?>" value="<?php echo number_format($row->QTY_AK, 2, '.', ','); ?>" type="text" class="form-control QTY_AK rightJustified text-primary"></td>
						...
						<tfoot>
							...
							<TD><input class="form-control TOTAL_QTY_AK rightJustified text-primary font-weight-bold" id="TOTAL_QTY_AK" name="TOTAL_QTY_AK" value="<?php echo number_format($rowh->TOTAL_QTY_AK,2,'.',',');?>" readonly></td>
							<td></td>
							<td></td>
						</tfoot>
					</table>
