...
<div class="container-fluid">
	...
	<form id="history_po" name="history_po" action="<?php echo base_url('admin/Transaksi_HistoryPO/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
