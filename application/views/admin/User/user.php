...
<section>
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <form action="<?= base_url('admin/user/index_user'); ?>" method="post">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Search keyword.." name="keyword" value="<?php echo $this->session->userdata['keyword_user']; ?>" autocomplate="off" autofocus>
            ...
            <div class="col-md-2">
                ...
                ?>
                    <a class="btn  btn-md btn-success" href="<?php echo base_url('admin/user/input') ?>"> <i class="fas fa-plus fa-sm md-3"></i></a>
                <?php
                }
                ?>
        ...
        <form method="post" action="<?php echo base_url('admin/user/delete_multiple') ?>">
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        ...
                                        ?>
                                            <a class="dropdown-item" href="<?php echo base_url('admin/user/update/' . $userp->NO_ID) ?>"> <i class="fa fa-edit"></i> Edit</a>
                                        <?php } ?>
                                        <?php
                                        // hak akses untuk edit
                                        ...
                                        if (count($result2) == 1 || $level == 'super_admin' || $super_admin == '1') {
                                        ?>
                                            <a class="dropdown-item" href="<?php echo base_url('admin/user/lihat/' . $userp->NO_ID) ?>"> <i class="fa fa-edit"></i> Lihat</a>
                                        <?php } ?>
                                    </div>
                                </div>

                            </td>
                            <td><?php echo $userp->USERNAME ?></td>
                            <td><?php echo $userp->AKSES ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
    ...
    ?>
        ...
        <div class="modal fade" id="modal_hapus<?php echo $userp->NO_ID; ?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">

                    <!-- Ganti 8 -->

                    <form class="form-horizontal" method="post" action="<?php echo base_url('admin/user/delete/' . $userp->NO_ID) ?>">
                        ...
                        <div class="modal-footer">
                            ...
                            <!-- Ganti 9 -->
                            <input type="hidden" name="NO_ID" value="<?php echo $userp->NO_ID; ?>">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        thead.onclick = function(e) {
            ...
            $.ajax({
                type: 'get',
                url: '<?php echo base_url('index.php/admin/user/getOrder'); ?>',
                data: {
                    order: order
                },
                success: function(response) {
                    console.log(response);
                    window.location.href = '<?php echo base_url('index.php/admin/user/index_user'); ?>';
        ...
        var ord = '<?php echo $this->session->userdata['order_user'] ?>';
