...
<div class="container-fluid">
	...
	<form method="post" action="">
		...
		<div class="form-group">
			...
			<input type="text" id="USERNAME" name="USERNAME" class="form-control" placeholder="Email Address" value="<?php echo $USERNAME; ?>" readonly>
		...
		<div class=" form-group">
			<label>Nama</label>
			<input type="text" id="NAMA" name="NAMA" class="form-control" placeholder="Nama" value="<?php echo $NAMA; ?>" readonly>
			<?= form_error('NAMA', '<small class="text-danger pl-3" ?>', '</small>'); ?>
		</div>

		<div class="form-group">
			<label>Telpon</label>
			<input type="text" id="TELPON" name="TELPON" class="form-control" placeholder="Telpon" value="<?php echo $TELPON; ?>" readonly>
			<?= form_error('TELPON', '<small class="text-danger pl-3" ?>', '</small>'); ?>
		</div>

		<div class="form-group">
			<label>HP</label>
			<input type="text" id="HP" name="HP" class="form-control" placeholder="Hp" value="<?php echo $HP; ?>" readonly>
		...
		<div class="form-group">
			...
			<div class="col-sm-4 nopadding">
				<select class="form-control" name="AKSES" id="AKSES" style="width: 100%;" readonly>
					<?php
