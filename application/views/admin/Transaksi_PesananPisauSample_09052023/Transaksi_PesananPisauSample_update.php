...
<div class="container-fluid">
	...
	<form id="cnc" name="cnc" action="<?php echo base_url('admin/Transaksi_PesananPisauSample/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
