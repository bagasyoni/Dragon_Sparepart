...
<div class="container-fluid">
	...
	<form id="transaksippstok" name="transaksippstok" action="<?php echo base_url('admin/Transaksi_PP_Stok/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2 input-group">
							<input name="NO_BUKTI_BELI_BON" id="NO_BUKTI_BELI_BON" maxlength="50" type="text" class="form-control NO_BUKTI_BELI_BON text_input" onkeypress="return tabE(this,event)" readonly>
					...
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody>
							<tr>
								...
								<td>
									<select class="js-example-responsive-kd_brg form-control KD_BRG0" name="KD_BRG[]" id="KD_BRG0" onchange="kd_brg(this.id)" onfocusout="hitung()"></select>
								</td>
								...
								<td><input name="DEVISI[]" id="DEVISI0" type="text" class="form-control DEVISI"></td>
								...
								<td><input name="SISA[]" onkeyup="hitung()" value="0" id="SISA0" type="text" class="form-control SISA rightJustified text-primary"></td>
								<td>
				...
				<table class='table table-bordered' id='modal_beli'>
					...
					?>
						<tr>
							...
							<td class='SPBVAL text_input'><?php echo $b->SP;?></td>
