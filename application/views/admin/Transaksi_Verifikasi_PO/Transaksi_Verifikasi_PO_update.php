...
<div class="container-fluid">
	...
	<form id="transaksiverifikasipo" name="transaksiverifikasipo" action="<?php echo base_url('admin/Transaksi_Verifikasi_PO/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2">
							<input class="form-control text_input KODES" id="KODES" name="KODES" type="text" value="<?php echo $rowh->KODES ?>" readonly>
						</div>
				...
				<div class="col-md-12">
					<div class="form-group row">
						...
						<input 
								type="text" 
								class="date form-control JTEMPO text_input" 
								id="JTEMPO" 
								name="JTEMPO" 
								data-date-format="dd-mm-yyyy" 
								value="<?php if (isset($_POST["tampilkan"])) { echo $_POST["JTEMPO"]; } else echo date('d-m-Y'); ?>" 
								onclick="select()"
								readonly
							>
						</div>
				...
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-1">
							<input class="form-control text_input UANG" id="UANG" name="UANG" type="text" value="<?php echo $rowh->UANG ?>" readonly>
						</div>
						<div class="col-md-2">
							<label class="label"></label>
						</div>
						...
						<div class="col-md-1">
							<input class="form-control text_input ATT" id="ATT" name="ATT" type="text" value="<?php echo $rowh->ATT ?>" readonly>
						</div>
					</div>
				</div>
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2">
							<input class="form-control text_input NOPOPPC" id="NOPOPPC" name="NOPOPPC" type="text" value="<?php echo $rowh->NOPOPPC ?>" readonly>
						</div>
					</div>
				</div>
				<div class="col-md-12">
				...
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tfoot>
							...
							<td></td>
							<td></td>
							<td><input class="form-control TOTAL_QTYA rightJustified text-primary font-weight-bold" id="TOTAL_QTYA" name="TOTAL_QTYA" value="" readonly></td>
							<td></td>
						</tfoot>
					</table>
				</div>
...
<script>
	...
	function btPosting() {
		...
		if (confirm("Yakin Posting?")){
			...
			window.location.replace("<?= base_url('admin/Transaksi_Verifikasi_PO/verifikasi_bl_po/'.$rowh->ID)?>");
		}
	}
