...
<div class="container-fluid">
	...
	<form id="pplama" name="pplama" action="<?php echo base_url('admin/Transaksi_PPLama/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
...
<script>
	...
	function select_kd_bhn() {
		$('.js-example-responsive-kd_bhn').select2({
			ajax: {
				url: "<?= base_url('admin/Transaksi_PPLama/getDataAjax_bhn') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
