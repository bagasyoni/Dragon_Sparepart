...
<section>
    ...
    <div class="container-fliud mx-4">
        ...
        <form method="post" action="<?php echo base_url('admin/Transaksi_PesananCetakan/delete_multiple') ?>">
...
<!-- Modal -->
<div class="modal fade" id="cetakanModal" tabindex="-1" role="dialog" aria-labelledby="periodeLabel" aria-hidden="true">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('admin/Transaksi_PesananCetakan/get_ajax_pp') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0, 1, 2],
