...
<div class="container-fluid">
	...
	<form method="post" action="<?php echo base_url('admin/mmenu/update_aksi') ?>">
		...
		<div class="form-group">
			...
			<input type="text" name="NAMA_MENU" class="form-control" value="<?php echo $rowh->NAMA_MENU ?>">
			<?php echo form_error('NAMA_MENU', '<div class="text-danger small" ml-3> ') ?>
		</div>
		<div class="form-group">
			<label>Level Menu</label>
			<input type="text" name="LEVEL" class="form-control" value="<?php echo $rowh->LEVEL ?>">
		...
		<div class="form-group">
			...
			<input type="text" name="URL_MENU" class="form-control" value="<?php echo $rowh->URL_MENU ?>">
