...
<div class="container-fluid">
	...
	<form id="bonnonstok" name="bonnonstok" action="<?php echo base_url('admin/Transaksi_BonNonStok/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
		...
		<br>
		<div class="row" <?php if ($rowh->TTD2 == !0) echo 'style="visibility: hidden;"'; ?>>
			<div class="col-xs-9">
				<div class="wells">
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td class='VABVAL text_input'><?php echo $b->TTD2; ?></td>
