...
<div class="container-fluid">
	...
	<div class="alert alert-success alert-container" role="alert">
		<i class="fas fa-university"></i> Update Master Barang
	</div>
	<form id="masterbarang" name="masterbarang" action="<?php echo base_url('admin/Master_Barang/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<br><br>
		<div class="form-body">
			<div class="col-md-12">
				<div class="form-group row">
					...
					<div class="col-md-3 ">
						<input type="hidden" id="NO_ID" name="NO_ID" class="form-control" value="<?= $rowh->NO_ID ?>">
						<input type="text" id="KD_BHN" name="KD_BHN" class="form-control text_input KD_BHN" value="<?= $rowh->KD_BHN ?>" readonly>
					</div>
					<div class="col-md-1">
						<label class="label">Nama Barang</label>
					</div>
					<div class="col-md-3 ">
						<input type="text" id="NA_BHN" name="NA_BHN" class="form-control text_input NA_BHN" value="<?= $rowh->NA_BHN ?>" readonly>
					</div>
				</div>
			</div>
			<div class="col-md-12">
				<div class="form-group row">
					...
					<div class="col-md-2 ">
						<input type="text" id="SATUAN" name="SATUAN" class="form-control text_input SATUAN" value="<?= $rowh->SATUAN ?>" readonly>
					</div>
				</div>
			</div>
			<div class="col-md-12">
