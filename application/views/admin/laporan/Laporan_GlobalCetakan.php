...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Global Cetakan
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="barangperruangan" method="post" action="<?php echo base_url('admin/laporan/index_GlobalCetakan') ?>">
            <div class="col-md-12">
