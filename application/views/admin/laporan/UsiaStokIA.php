...
<section>
    <div class="container-fluid">
		...
		<div class="alert alert-success alert-container" role="alert">
            <i class="fas fa-university"></i> Laporan Usia Stok IA
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="usiastokia" method="post" action="<?php echo base_url('admin/laporan/index_UsiaStokIA') ?>">
            <div class="col-md-12">
