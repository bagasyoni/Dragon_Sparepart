...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Inventaris Cetakan
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="barangperruangan" method="post" action="<?php echo base_url('admin/laporan/index_InventarisCetakan') ?>">
            <div class="col-md-12">
