...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-money"></i> Laporan Monitor Order Lasting
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="laporan_atk" method="post" action="<?php echo base_url('admin/laporan/index_MonitorOrderLasting') ?>">
            <!-- <div class="col-md-12">
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $monitor_orderlasting,
                    "name" => "example",
                    "showFooter" => true,
                    "showFooter" => "bottom",
                    "columns" => array(
