...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-money"></i> Laporan Proses Order Pembelian (COR) Per No PP
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="laporan_proses_order_pembelian_cor_pp" method="post" action="<?php echo base_url('admin/laporan/index_ProsesOrderPembelianCORPerNoPP') ?>">
            <!-- <div class="col-md-12">
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $proses_order_pembelian_cor_pp,
                    "name" => "example",
                    "showFooter" => true,
                    "showFooter" => "bottom",
                    "columns" => array(
