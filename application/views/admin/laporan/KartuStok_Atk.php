...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-money"></i> Laporan Kartu Stok Atk
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="kartustok" method="post" action="<?php echo base_url('admin/laporan/index_KartuStokAtk') ?>">
            <div class="col-md-12">
