...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Inventaris Global
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="inventarisglobal" method="post" action="<?php echo base_url('admin/laporan/index_InventarisGlobal') ?>">
            <div class="col-md-12">
