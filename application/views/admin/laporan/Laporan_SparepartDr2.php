...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-money"></i> Laporan Sparepart DR 2
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="laporan_atk" method="post" action="<?php echo base_url('admin/laporan/index_SparepartDR2') ?>">
            <div class="col-md-6">
