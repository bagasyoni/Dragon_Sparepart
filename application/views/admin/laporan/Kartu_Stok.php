...
<section>
    <div class="container-fluid">
        ...
        <form id="bayarnosj" method="post" action="<?php echo base_url('admin/laporan/index_Kartu_Stok') ?>">
            <div class="col-md-12">
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <input type="text" id="KD_BRG_1" name="KD_BRG_1" class="form-control KD_BRG_1" placeholder="Semua barang ...">
                    </div>
                    <div class="col-md-1">
...
<script>
    ...
    function select_rak_1() {
        $('#RAK_1').select2({
            ajax: {
                url: "<?= base_url('admin/laporan/getData_brg_rak_1') ?>",
                dataType: "json",
                type: "post",
                delay: 250,
