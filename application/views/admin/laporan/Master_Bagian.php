...
<section>
    <div class="container-fluid">
        ...
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Master Bagian
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="masterbarang" method="post" action="<?php echo base_url('admin/laporan/index_MasterBagian') ?>">
            <div class="col-md-6">
