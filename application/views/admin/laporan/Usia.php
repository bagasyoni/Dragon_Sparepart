...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Usia
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="usia" method="post" action="<?php echo base_url('admin/laporan/index_Usia') ?>">
            <div class="col-md-12">
                <div class="form-group row">
                    ...
                    <div class="col-md-1">
                        <label class="label-title">Masa </label>
                    </div>
                    <div class="col-md-3 nopadding">
                        <input type="text" value="<?= $MASA ?>" class="form-control form-control-user" maxlength="2" id="MASA" placeholder="" name="MASA">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
