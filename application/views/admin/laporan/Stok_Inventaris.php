...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-money"></i> Stok Inventaris
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="bulanan" method="post" action="<?php echo base_url('admin/laporan/index_Stok_Inventaris') ?>">
            <!-- <div class="col-md-12">
