...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-money"></i> Laporan LPB Harian
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="lpbharian" method="post" action="<?php echo base_url('admin/laporan/index_LPB_Harian') ?>">
            <div class="col-md-12">
