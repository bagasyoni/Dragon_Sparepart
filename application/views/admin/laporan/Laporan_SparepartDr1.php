...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-money"></i> Laporan Sparepart DR 1
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="laporan_atk" method="post" action="<?php echo base_url('admin/laporan/index_SparepartDR1') ?>">
            <div class="col-md-6">
