...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-money"></i> Laporan Proses Order Internal
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="laporan_proses_order_internal" method="post" action="<?php echo base_url('admin/laporan/index_ProsesOrderInternal') ?>">
            <!-- <div class="col-md-12">
            ...
            <div class="report-content">
                ...
                DataTables::create(array(
                    "dataStore" => $proses_order_internal,
                    "name" => "example",
                    "showFooter" => true,
                    "showFooter" => "bottom",
                    "columns" => array(
