...
<section>
    <div class="container-fluid">
        <div class="alert alert-success" role="alert">
            <i class="fas fa-university"></i> Laporan Pemeliharaan
        </div>
        <?php echo $this->session->flashdata('pesan') ?>
        <form id="pemeliharaan" method="post" action="<?php echo base_url('admin/laporan/index_Pemeliharaan') ?>">
            <div class="col-md-12">
