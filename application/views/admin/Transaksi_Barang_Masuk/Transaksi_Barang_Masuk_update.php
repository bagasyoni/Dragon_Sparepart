								...
								<tr>
									...
									<td>
										<div class='input-group'>
											<select <?php if ($rowh->VAL == !0) echo 'readonly'; ?> value="<?= $row->RAK ?>" class="js-example-responsive-kd_bhn form-control RAK" name="RAK[]" id="RAK0" onchange="kd_bhn(this.id)" onfocusout="hitung()"></select>
										</div>
									</td>
