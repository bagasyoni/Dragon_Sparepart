						...
						<tbody>
							...
							?>
								<tr>
									...
									<td><input  name="QTY_BL[]" onkeyup="hitung()" id="QTY_BL<?php echo $no; ?>" value="<?php echo number_format($row->QTY, 2, '.', ','); ?>" type="text" class="form-control QTY_BL rightJustified text-primary" readonly></td>
									<!-- <td><input  name="SAT_BL[]" id="SAT_BL<?php echo $no; ?>" value="<?= $row->SAT_BL ?>" type="text" class="form-control SAT_BL text_input"></td> -->
									<td><input  name="SATUAN_BL[]" id="SATUAN_BL<?php echo $no; ?>" value="<?= $row->SAT_BL ?>" type="text" class="form-control SATUAN_BL text_input"></td>
