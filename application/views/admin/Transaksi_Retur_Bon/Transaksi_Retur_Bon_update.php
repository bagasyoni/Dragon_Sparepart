<?php
	foreach ($transaksi_retur_bon as $rowh) {};
?>
...
<div class="container-fluid">
	...
	<form id="transaksireturbon" name="transaksireturbon" action="<?php echo base_url('admin/Transaksi_Retur_Bon/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
			...
			<div class="col-md-12">
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<?php
							$no = 0;
							foreach ($transaksi_retur_bon as $row) : 
						?>
							<tr>
...
<script>
	...
	function select_kd_bhn() {
		$('.js-example-responsive-kd_bhn').select2({
			ajax: {
				url: "<?= base_url('admin/Transaksi_Retur_Bon/getDataAjax_Bahan') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
