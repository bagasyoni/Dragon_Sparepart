...
<div class="container-fluid">
	...
	<form id="transaksireturbon" name="transaksireturbon" action="<?php echo base_url('admin/Transaksi_Retur_Bon/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
...
<script>
	...
	function hitung() {
		...
		for (i=0;i<total_row;i++) {
			...
			$('#QTY'+i).val(numberWithCommas(_qty));
			$('#QTY'+i).autoNumeric('update');
