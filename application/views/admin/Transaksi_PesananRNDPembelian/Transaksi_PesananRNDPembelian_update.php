...
<div class="container-fluid">
	...
	<form id="cnc" name="cnc" action="<?php echo base_url('admin/Transaksi_PesananRNDPembelian/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2">
							<input class="form-control text_input NO_PO" id="NO_PO" name="NO_PO" type="text" value="<?php echo $rowh->NO_PO ?>" readonly>
						</div>
					</div>
				</div>
				<div class="col-md-12">
				...
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-2">
							<input type="text" class="date form-control TGL_MARKETING text_input" id="TGL_MARKETING" name="TGL_MARKETING" data-date-format="dd-mm-yyyy" value="<?php echo date('d-m-Y', strtotime($rowh->TGL_MARKETING, TRUE)); ?>" onclick="select()">
						</div>
					</div>
				</div>
				<div class="col-md-12">
