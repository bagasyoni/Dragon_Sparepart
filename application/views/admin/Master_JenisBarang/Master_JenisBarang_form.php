...
<div class="container-fluid">
	...
	<div class="alert alert-success alert-container" role="alert">
		<i class="fas fa-university"></i> Entry Master Jenis Barang
	</div>
	<form id="jenisbarang" name="jenisbarang" action="<?php echo base_url('admin/Master_JenisBarang/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<br><br>
		<div class="form-body">
			<div class="col-md-12">
