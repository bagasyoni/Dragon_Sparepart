<?php
foreach ($pemesananlogistik as $rowh) {
};
?>
...
<div class="container-fluid">
	...
	<form id="pemesananlogistik" name="pemesananlogistik" action="<?php echo base_url('admin/Transaksi_PemesananLogistik/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
				...
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody>
							<?php
							$no = 0;
							foreach ($pemesananlogistik as $row) :
							?>
								<tr>
...
<script>
	...
	function btVerifikasi() {
		if (confirm("Yakin Posting?")) {
			...
			window.location.replace("<?php echo base_url('admin/Transaksi_PemesananLogistik/verifikasi_ttd1/' . $rowh->ID) ?>");
		} else {
			alert("Batal Posting!");
		}
	}
