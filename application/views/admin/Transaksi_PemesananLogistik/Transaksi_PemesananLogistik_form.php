...
<div class="container-fluid">
	...
	<form id="pemesananlogistik" name="pemesananlogistik" action="<?php echo base_url('admin/Transaksi_PemesananLogistik/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group row">
						...
						<div class="col-md-5">
							<label class="label"><strong style="color: red;">*</strong> Untuk PP Logistik Dengan Master Bahan, PP Dengan No Bon Dimenu Pemesanan </label>
						</div>
						<!-- <div class="col-md-2 input-group">
							<input name="NO_BL" id="NO_BL" maxlength="50" type="text" class="form-control NO_BL text_input" onkeypress="return tabE(this,event)" readonly>
							...
							<tr>
								...
								<td>
									<div class='input-group'>
										<select value="" class="js-example-responsive-kd_bhn form-control KD_BHN" name="KD_BHN[]" id="KD_BHN0" onchange="kd_bhn(this.id)" onfocusout="hitung()"></select>
									</div>
								</td>
								...
								<td><input name="DEVISI[]" id="DEVISI0" type="text" class="form-control DEVISI text_input"></td>
								...
								<td>
									<input name="URGENT[]" id="URGENT0" type="checkbox" value="1" class="checkbox_container" unchecked>
								</td>
								<td>
...
<script>
	...
	function tambah() {
		...
		td11.innerHTML = "<input name='URGENT[]' id=URGENT" + idrow + " type='checkbox' class='checkbox_container' value='1' unchecked>";
...
<script>
	...
	function select_kd_bhn() {
		$('.js-example-responsive-kd_bhn').select2({
			ajax: {
				url: "<?= base_url('admin/Transaksi_PemesananLogistik/getDataAjax_bhn') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
