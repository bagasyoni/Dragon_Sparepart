...
<div class="container-fluid">
	...
	<form id="transaksipemesananproyek" name="transaksipemesananproyek" action="<?php echo base_url('admin/Transaksi_Pemesanan_Proyek/input_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
