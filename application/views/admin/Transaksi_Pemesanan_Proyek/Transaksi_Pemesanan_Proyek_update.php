...
<div class="container-fluid">
	...
	<form id="transaksipemesananproyek" name="transaksipemesananproyek" action="<?php echo base_url('admin/Transaksi_Pemesanan_Proyek/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
			...
			<div class="col-md-12">
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<?php
							$no = 0;
							foreach ($transaksi_pemesanan_proyek as $row) : 
						?>
							<tr>
								...
								<td>
									<div class="input-group">
										<select class="js-example-responsive-kd_bhn form-control KD_BHN" name="KD_BHN[]" id="KD_BHN<?php echo $no; ?>" onchange="kd_bhn(this.id)" required>
...
<script>
	...
	function select_kd_bhn() {
		$('.js-example-responsive-kd_bhn').select2({
			ajax: {
				url: "<?= base_url('admin/Transaksi_Pemesanan_Proyek/getDataAjax_Bahan') ?>",
				dataType: "json",
				type: "post",
				delay: 10,
