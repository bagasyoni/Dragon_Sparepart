...
<div class="container-fluid">
	...
	<form id="cnc" name="cnc" action="<?php echo base_url('admin/Transaksi_PesananLasting/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td><input name="TIPE[]" id="TIPE<?php echo $no; ?>" value="<?= $row->TIPE ?>" type="text" class="form-control TIPE text_input"></td>
