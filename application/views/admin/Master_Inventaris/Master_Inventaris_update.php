...
<div class="container-fluid">
	...
	<form id="inventaris" name="inventaris" action="<?php echo base_url('admin/Master_Inventaris/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
		<div class="form-body">
			<div class="row">
				<div class="col-md-12">
				...
				<div class="table-responsive scrollable">
					<table id="datatable" class="table table-hoverx table-stripedx table-borderedx table-condensed table-scrollable">
						...
						<tbody>
							...
							?>
								<tr>
									<td><input name="RECX" id="RECX" value="<?= $no+1 ?>" type="text" class="form-control RECX text_input"  readonly>
									<input name="REC[]" id="REC<?php echo $no; ?>" value="<?= $row->REC ?>" type="text" class="form-control REC text_input" onkeypress="return tabE(this,event)" hidden>	
									</td>
									...
									<td>
										<input name="TGL_KE[]" id="TGL_KE<?php echo $no; ?>" type="text" class="date form-control text_input" data-date-format="dd-mm-yyyy" value="<?php echo date('d-m-Y', strtotime($row->TGL_KE, TRUE)); ?>" onclick="select()">
									</td>
									<td>
										<input name="TGL_MU[]" id="TGL_MU<?php echo $no; ?>" type="text" class="date form-control text_input" data-date-format="dd-mm-yyyy" value="<?php echo date('d-m-Y', strtotime($row->TGL_MU, TRUE)); ?>" onclick="select()">
									</td>
									<td>
