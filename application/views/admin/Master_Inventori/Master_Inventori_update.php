...
<div class="container-fluid">
    ...
    <div class="alert alert-success alert-container" role="alert">
        <i class="fas fa-university"></i> Update Master Inventori
    </div>
	<form id="masterinventori" name="masterinventori" action="<?php echo base_url('admin/Master_Inventori/update_aksi'); ?>" class="form-horizontal needs-validation" method="post" novalidate>
        <br><br>
        <div class="form-body">
			<div class="col-md-12">
				<div class="form-group row">
					...
					<div class="col-md-3 ">
						...
						<input type="text" id="NO_BUKTI" name="NO_BUKTI" class="form-control text_input NO_BUKTI" value="<?= $NO_BUKTI ?>">
					</div>
					<div class="col-md-1">
						<label class="label">Kode</label>
					</div>
					<div class="col-md-3 ">
						<input type="text" id="KODE" name="KODE" class="form-control text_input KODE" value="<?= $KODE ?>">
					</div>
					<div class="col-md-1">
						<label class="label">Nama </label>
					</div>
					<div class="col-md-3 ">
						<input type="text" id="NAMA" name="NAMA" class="form-control text_input NAMA" value="<?= $NAMA ?>">
					</div>
				</div>
			</div>
			<div class="col-md-12">
				<div class="form-group row">
					...
					<div class="col-md-3 ">
						<input type="text" id="BAGIAN" name="BAGIAN" class="form-control text_input BAGIAN" value="<?= $BAGIAN ?>">
					</div>
					<div class="col-md-1">
						<label class="label">J Barang</label>
					</div>
					<div class="col-md-3">
						<input type="text" id="J_BARANG" name="J_BARANG" class="form-control text_input J_BARANG" value="<?= $J_BARANG ?>">
					</div>
					<div class="col-md-1">
						<label class="label">Merk</label>
					</div>
					<div class="col-md-3">
						<input type="text" id="MERK" name="MERK" class="form-control text_input MERK" value="<?= $MERK ?>">
					</div>
				</div>
			</div>
			<div class="col-md-12">
				<div class="form-group row">
					...
					<div class="col-md-3 ">
						<input type="text" class="date form-control" id="TGL_MA" name="TGL_MA" data-date-format="dd-mm-yyyy" value="<?php echo date('d-m-Y', strtotime($TGL_MA,TRUE)); ?>" >
					</div>
					<div class="col-md-1">
						<label class="label">Tgl Keluar</label>
					</div>
					<div class="col-md-3 ">
						<input type="text" class="date form-control" id="TGL_KE" name="TGL_KE" data-date-format="dd-mm-yyyy" value="<?php echo date('d-m-Y', strtotime($TGL_KE,TRUE)); ?>" >
					</div>
					<div class="col-md-1">
						<label class="label">Tgl Mutasi</label>
					</div>
					<div class="col-md-3 ">
						<input type="text" class="date form-control" id="TGL_MUTASI" name="TGL_MUTASI" data-date-format="dd-mm-yyyy" value="<?php echo date('d-m-Y', strtotime($TGL_MUTASI,TRUE)); ?>" >
					</div>
				</div>
			</div>
			<div class="col-md-12">
				<div class="form-group row">
					...
					<div class="col-md-3 ">
						<input type="text" id="JUMLAH" name="JUMLAH" class="form-control number_input JUMLAH num" value="<?php echo number_format($JUMLAH,0,'.',',');?>">
					</div>
					<div class="col-md-1">
					...
					<div class="col-md-3">
						<input type="text" id="KETER" name="KETER" class="form-control text_input KETER" value="<?= $KETER ?>">
					</div>
				</div>
			</div>
			<div class="col-md-12">
				<div class="form-group row">
					...
					<div class="col-md-3 ">
						<input type="text" id="TEMPAT" name="TEMPAT" class="form-control text_input TEMPAT" value="<?= $TEMPAT ?>">
					</div>
					<div class="col-md-1">
						<label class="label">Rec</label>
					</div>
					<div class="col-md-3">
						<input type="text" id="REC" name="REC" class="form-control number_input REC num" value="<?php echo number_format($REC,0,'.',',');?>">
					</div>
					<div class="col-md-1">
						<label class="label">Kode Barang</label>
					</div>
					<div class="col-md-3">
						<input type="text" id="KD_BRG" name="KD_BRG" class="form-control text_input KD_BRG" value="<?= $KD_BRG ?>">
					</div>
				</div>
			</div>
        </div>
