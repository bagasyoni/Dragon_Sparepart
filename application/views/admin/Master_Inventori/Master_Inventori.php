...
<section>
    ...
    <div class="container-fliud mx-4">
        ...
        <form method="post" action="<?php echo base_url('admin/Master_Inventori/delete_multiple') ?>">
            ...
            <table id="example" class="table table-bordered table-striped table-hover table-responsive bodycontainer scrollable" style="width:100%;">
                <thead>
                    <tr>
                        ...
                        <th width="75px">No</th>
                        <th width="175px">No Bukti</th>
                        <th width="200px">Kode</th>
                        <th width="150px">Nama</th>
                        <th width="125px">Bagian</th>
                        <th width="100px">J Barang</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('admin/Master_Inventori/get_ajax_sp_inven') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0, 1, 2],
