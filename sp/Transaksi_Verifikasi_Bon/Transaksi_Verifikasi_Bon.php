...
<section>
    ...
    <div class="container-fliud mx-4">
        ...
        <form method="post" action="<?php echo base_url('admin/Transaksi_Verifikasi_Bon/delete_multiple') ?>">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('admin/Transaksi_Verifikasi_Bon/get_ajax_bl_bon') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0, 1, 2],
        ...
        $("div.test_btn").html('  <a style="visibility: hidden;" class="btn  btn-md btn-success" href="input"> <i class="fas fa-plus fa-sm md-3" ></i></a> ' +
            ' <button style="visibility: hidden;" type="submit" class="btn btn-md btn-danger" onclick="return confirm(&quot; Apakah Anda Yakin Ingin Menghapus? &quot;)"> <i class="fas fa-trash fa-sm md-3"></i></button> ' +
            '  <a class="btn style="visibility: hidden;" btn-md btn-primary"  href="<?php echo site_url('admin/account/print') ?>"></a> '
        );
        $('#example').show();
